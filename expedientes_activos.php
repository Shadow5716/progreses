...
// Añadimos WHERE e.estatus = 'ACTIVO' para filtrar la lista
...
<head>
    <meta charset="UTF-8">
    <title>SAMI - Expedientes Activos</title>
...
<body class="bg-light">
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3><i class="bi bi-folder-check me-2"></i>Expedientes Activos</h3>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php if (count($expedientes) > 0): ?>
                            ...
                            <tr>
                                <td class="fw-bold text-primary"><?php echo $exp['nro_expediente']; ?></td>
                                <td>
...
<a href="<?php echo ($adminActual['Rango'] == 'Operador') ? 'ver_expediente.php' : 'gestion_expediente.php'; ?>?nro=<?php echo $exp['nro_expediente']; ?>" 
   class="btn btn-sm btn-outline-primary">
    <i class="bi bi-eye"></i> Ver Ficha
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" class="text-center py-4 text-muted">No hay expedientes activos actualmente.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
